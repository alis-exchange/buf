...
# Settable
# https://github.com/alis-exchange/buf/releases 20240307 checked 20240320
BUF_VERSION ?= v1.30.0
# Settable
#
...
# "go install github.com/alis-exchange/buf/cmd/buf".
BUF_GO_INSTALL_PATH ?=
...
$(BUF):
	@rm -f $(CACHE_BIN)/buf
	GOBIN=$(CACHE_BIN) go install github.com/alis-exchange/buf/cmd/buf@$(BUF_VERSION)
	@rm -rf $(dir $(BUF))
	@mkdir -p $(dir $(BUF))
	@touch $(BUF)
