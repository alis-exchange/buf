...
# Settable
# https://github.com/alis-exchange/buf/releases
...
$(GIT_LS_FILES_UNSTAGED):
	...
	GOBIN=$(CACHE_BIN) go install github.com/alis-exchange/buf/private/pkg/git/cmd/git-ls-files-unstaged@$(GIT_LS_FILES_UNSTAGED_VERSION)
